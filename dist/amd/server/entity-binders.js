define(['exports', './entity-listener'], function (exports, _entityListener) {
  'use strict';
  ...
  var _EntityListener = _interopRequireDefault(_entityListener);
  ...
  var EntityBinders = (function () {
    function EntityBinders(options) {
      ...
      this.tableBinders = tableNames.reduce(function (obj, tableName) {
        obj[tableName] = new _EntityListener['default'](tableName, options);
        return obj;
      }, {});
    }
