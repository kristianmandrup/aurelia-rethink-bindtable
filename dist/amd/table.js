define(['exports', 'module', './util', './record'], function (exports, module, _util, _record) {
  'use strict';
  ...
  var _createPromise = _interopRequireDefault(_util);
  ...
  var Table = (function () {
    ...
    Table.prototype.on = function on(record) {
      ...
      return new _Record['default'](this, record, this.options);
    };
    ...
    Table.prototype.findById = function findById(id) {
      ...
      var promise = _createPromise['default'](function (reject, resolve) {
